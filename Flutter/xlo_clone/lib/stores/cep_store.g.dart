...
mixin _$CepStore on _CepStore, Store {
  ...
  void setAddress(Address value) {
    final _$actionInfo =
        _$_CepStoreActionController.startAction(name: '_CepStore.setAddress');
    try {
  ...
  void setError(String value) {
    final _$actionInfo =
        _$_CepStoreActionController.startAction(name: '_CepStore.setError');
    try {
  ...
  void setLoading(bool value) {
    final _$actionInfo =
        _$_CepStoreActionController.startAction(name: '_CepStore.setLoading');
    try {
